...
public class AuthenticationView1 {
...
//        jsonBody.put("paramValue",new String[]{"330203198903010617"});
        jsonBody.put("paramValue",new String[]{"110101199607286819"});
...
//        System.out.println("result结果示例: " + certificateNo);
//        System.out.println("result结果示例: " + pic);
    }
}
