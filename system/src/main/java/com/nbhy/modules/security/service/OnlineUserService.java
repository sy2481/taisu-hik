...
public class OnlineUserService {
     ...
     * @return /
     */
    public Map<String,Object> getAll(String filter, PageQuery pageable){
        List<OnlineUserDto> onlineUserDtos = getAll(filter);
        return PageUtil.toPage(
                PageUtil.toPage(pageable.getPageIndex(),pageable.getPageSize(), onlineUserDtos),
                Long.valueOf(onlineUserDtos.size()),
                pageable
        );
    }
