...
//    @ApiOperation("日志查询")
//    @PreAuthorize("@el.check()")
//    public ResponseEntity<Object> query(LogQueryCriteria criteria, PageQuery pageable){
//        criteria.setLogType("INFO");
...
//    @ApiOperation("用户日志查询")
//    public ResponseEntity<Object> queryUserLog(LogQueryCriteria criteria, PageQuery pageable){
//        criteria.setLogType("INFO");
...
//    @ApiOperation("错误日志查询")
//    @PreAuthorize("@el.check()")
//    public ResponseEntity<Object> queryErrorLog(LogQueryCriteria criteria, PageQuery pageable){
//        criteria.setLogType("ERROR");
//        return new ResponseEntity<>(logService.queryAll(criteria,pageable), HttpStatus.OK);
//    }
//
